...
function gateKeeper(req, res, next) {
  ...
  const parsedQuery = queryString.parse(req.get('x-username-and-password'));
  console.log(parsedQuery);
  console.log(parsedQuery.user);
  req.user = USERS.find(
    (user, index) => user.userName === parsedQuery.user && user.password === parsedQuery.pass);
  next();
}
